...
/** Trait for parts that are simply a cuboid, having one bounding box. Overrides
  * multipart functions to this effect.
  */
trait TCuboidPart extends TMultiPart {
  ...
  override def getSubParts: Iterable[IndexedCuboid6] = Seq(
    new IndexedCuboid6(0, getBounds)
  )
